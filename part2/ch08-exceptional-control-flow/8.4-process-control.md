...
![图 8-16   图 8-15 中示例程序的进程图](<../..//_imgs/gitbook-assets/08-16 图8-15中示例程序的进程图.png>)
...
![图 8-17 嵌套 fork 的进程图](<../..//_imgs/gitbook-assets/08-17 嵌套fork的进程图.png>)
...
![图 8-47 练习题 8.2 的进程图](../..//_imgs/gitbook-assets/0847-lian-xi-ti-8.2-de-jin-cheng-tu-.png)
...
![图 8-48 练习题 8.3 的进程图](../..//_imgs/gitbook-assets/0848-lian-xi-ti-8.3-de-jin-cheng-tu-.png)
...
![图 8-49 练习题 8.4 的进程图](../..//_imgs/gitbook-assets/0849-lian-xi-ti-8.4-de-jin-cheng-tu-.png)
...
![图 8-20 参数列表的组织结构](../..//_imgs/gitbook-assets/0820-can-shu-lie-biao-de-zu-zhi-jie-gou-.png)

环境变量的列表是由一个类似的数据结构表示的，如图 8-21 所示。envp 变量指向一个以 null 结尾的指针数组，其中每个指针指向一个环境变量字符串，每个串都是形如 “name=value” 的名字—值对。

![图 8-21 环境变量列表的组织结构](../..//_imgs/gitbook-assets/0821-huan-jing-bian-liang-lie-biao-de-zu-zhi-jie-gou-.png)
...
![图 8-22 一个新程序开始时，用户栈的典型组织结构](../..//_imgs/gitbook-assets/0822-yi-ge-xin-cheng-xu-kai-shi-shi-yong-hu-zhan-de-dian-xing-zu-zhi-jie-gou-.png)
